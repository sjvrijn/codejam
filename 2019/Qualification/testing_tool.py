...
def getTestCases(test_number):
    ...
    cases = [
        #Case([1, 2, 3], 4, F), Case([2, 3, 5], 6, F), Case([1000], 1024, F),
        *[Case(random.sample(range(31), n), 31, F) for n in range(5,16,5)],
        #*[Case(random.sample(range(32), n), 32, F) for n in range(5,16,5)],
        #*[Case(random.sample(range(33), n), 33, F) for n in range(5,16,5)],
        #*[Case(random.sample(range(64), n), 64, F) for n in range(5,16,5)],
        #*[Case(random.sample(range(128), n), 128, F) for n in range(5,16,5)],
        #*[Case(random.sample(range(256), n), 256, F) for n in range(5,16,5)],
        #*[Case(random.sample(range(512), n), 512, F) for n in range(5,16,5)],
    ]
